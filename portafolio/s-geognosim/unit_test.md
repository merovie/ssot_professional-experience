...
Verticales: ["V3", "V4"]
Dominios: ["#MaduracionTecnologica", "#EstimacionRecursos", "#TechnicalTranslation", "#MVP", "#StakeholderManagement", "#TPM", "#RemocionDeBloqueos", "#TechnicalTranslation", "#QAQC", "#IDi", "#Lean"]
---
